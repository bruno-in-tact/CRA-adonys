...
export default class CreateProjectValidator {
  ...
  public schema = schema.create({
    ...
    project_name: schema.string({trim: true },[rules.regex(/^[a-zA-Z]+$/),]),
    project_key: schema.string({trim: true },),
    client_name: schema.string({trim: true },),
    project_details: schema.string.optional({trim: true },),
    restaurant_ticket:schema.boolean(),
